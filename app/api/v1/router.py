...
from app.api.v1.endpoints import (
    accounts, auth, automations, campanias, crm_extras, ficha_config, fields, ingest, lead_bases, leads, lotes,
    records, reportes, roles, tipificaciones, ui_modules, users, voip, webhooks,
)
